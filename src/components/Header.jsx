                        ...
                        <Navbar.Text className="input_group">
                            <InputGroup className="mb-3">
                                ...
                                <Form.Control
                                    ...
                                    onChange={handleAdditionEndingBalance}
                                    type="number"
                                />
                            </InputGroup>
                            <InputGroup className="mb-3">
